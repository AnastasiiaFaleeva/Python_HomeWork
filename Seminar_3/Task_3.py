...
# очка;B, C, M, P – 3 очка;F, H, V, W, Y – 4 очка;K – 5 очков;J, X – 8
# очков;Q, Z – 10 очков.А русские буквы оцениваются
...
for char in word:
    if char in english_values:
        score += english_values[char]
    elif char in russian_values:
        score += russian_values[char]

print("Количество очков в слове:", score)